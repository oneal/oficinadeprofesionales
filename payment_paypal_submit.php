...
<?php echo $BIZBOOK['PLEASE_WAIT_PAYPAL'];?>
<form action="<?php echo $paypal_url; ?>" method="post" name="frmPayPal1" id="frmPayPal1">
    ...
    <?php /*<input type="hidden" name="cpp_header_image" value="https://www.phpgang.com/wp-content/uploads/gang.jpg">*/?>
    ...
    <?php /*<input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
