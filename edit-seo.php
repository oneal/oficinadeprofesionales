                ...
                <div class="log">
                    <div class="login add-list-off">
                        ...
                        <form action="seo_update.php" class="seo_edit_form" id="seo_edit_form" name="seo_edit_form"
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" readonly="readonly" name="seo_name" required="required" class="form-control"
                                                       value="<?php echo $name; ?>" placeholder="seo name">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="seo_title"  class="form-control"
                                                       value="<?php echo $seos_a_row['seo_title']; ?>"  placeholder="<?php echo $BIZBOOK['SEO_TITLE']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" required="required" name="seo_description" id="seo_description"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="seo_submit" class="btn btn-primary"><?php echo $BIZBOOK['SAVE_CHANGES']; ?></button>
                                </div>
                                <!--                                        <div class="col-md-6">-->
