            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login add-list-off">
                        ...
                        <form action="event_delete.php" class="event_delete_form" id="event_delete_form" name="event_delete_form"
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="event_name" readonly="readonly"  class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="event_address" readonly="readonly"  class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="date" name="event_start_date" readonly="readonly"  class="form-control"
                                                       value="<?php echo $events_a_row['event_start_date']; ?>" placeholder="<?php echo $BIZBOOK['DATE']; ?>*">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="event_time" readonly="readonly"  class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" readonly="readonly"  name="event_description"
...
<!--                                    </div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="event_contact_name" readonly="readonly"  class="form-control"
                                                       value="<?php echo $events_a_row['event_contact_name']; ?>" placeholder="<?php echo $BIZBOOK['CONTACT_PERSON']; ?>*">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="event_mobile" readonly="readonly"  class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="email" name="event_email" readonly="readonly"  class="form-control"
                                                       value="<?php echo $events_a_row['event_email']; ?>" placeholder="<?php echo $BIZBOOK['CONTACT_EMAIL_ID']; ?>*">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="event_website" class="form-control" readonly="readonly"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div>
                                                <div class="chbox">
                                                    <input type="checkbox" disabled="disabled" id="isenquiry" name="isenquiry" <?php if($events_a_row['isenquiry'] == 1){ ?>checked="" <?php }?>>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="event_submit" class="btn btn-primary"><?php echo $BIZBOOK['DELETE_EVENT']; ?></button>
                                </div>
                                <!--                                        <div class="col-md-6">-->
