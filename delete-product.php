                            ...
                            <ul>
                                <li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" readonly="readonly" name="product_name" id="product_name"
                                                       ...
                                                       value="<?php echo $products_a_row['product_name']; ?>"  placeholder="<?php echo $BIZBOOK['PRODUCT_NAME_STAR']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select disabled="disabled" onChange="getProductSubCategory(this.value);" name="category_id"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select disabled="disabled" name="sub_category_id[]" id="sub_category_id" multiple
                                                    ...
                                                    <!--                                            <option -->
                                                    <?php //if($products_a_row['sub_category_id'] == NULL){ echo "selected";} ?><!-- value="">Select Sub Category</option>-->
                                                    <?php
                                                    //                                            $sub_categories_row =  getCategorySubCategories($products_a_row['category_id']);
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" readonly="readonly" name="product_price" id="product_price"
                                                       value="<?php echo $products_a_row['product_price']; ?>" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['PRICE']; ?>*">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" readonly="readonly" name="product_price_offer" id="product_price_offer"
                                                       value="<?php echo $products_a_row['product_price_offer']; ?>"  class="form-control" placeholder="<?php echo $BIZBOOK['PRODUCT_OFFER']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
...
<!--                                                       class="form-control" accept="image/png, image/jpeg" multiple>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <!--FILED END-->
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <input type="text" readonly="readonly"
                                                                                   name="product_highlights[]" value="<?php echo $tuple; ?>"
                                                                                   class="form-control"
...
<!--                                                          title="remove offer">-</span>-->
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            <input type="text" readonly="readonly" class="form-control"
                                                                                   name="product_info_question[]" value="<?php echo $tuple[0]; ?>"
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            <input type="text" readonly="readonly" class="form-control"
                                                                                   name="product_info_answer[]" value="<?php echo $tuple[1]; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="product_submit" class="btn btn-primary"><?php echo $BIZBOOK['DELETE_PRODUCT']; ?></button>
                                </div>
                                <div class="col-md-12">
