                    ...
                    <div class="login">
                        ...
                        <form action="listing_update.php" id="listing_form_1"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="listing_mobile" name="listing_mobile" type="text"
                                               ...
                                               class="form-control" placeholder="<?php echo $BIZBOOK['PHONE_NUMBER']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $list_city_id = $listings_a_row['city_id'];
                                            $city_row = getCity($list_city_id);
                                            ?>
                                                                    
                                            <input id="select-city" name="city_id"
                                                value="
                                             <?php //echo $city_row['city_name']; ?>"
                                             required="required" type="text" class="form-control autocomplete"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="sub_category_id[]" id="sub_category_id" multiple
                                            ...
                                            <!--                                            <option -->
                                            <?php //if($listings_a_row['sub_category_id'] == NULL){ echo "selected";} ?><!-- value="">Select Sub Category</option>-->
                                            <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button name="listing_submit" type="submit" class="btn btn-primary"><?php echo $BIZBOOK['SAVED']; ?></button>
                                </div>
                                <div class="col-md-12">
