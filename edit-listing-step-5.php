...
//        $_SESSION['gallery_image'] = $_SESSION['gallery_image_old'];
//    } else {
...
//
//            }
//            $_SESSION['gallery_image'] = implode(",", $gallery_image1);
//
//        }
//    }
//
                            ...
                            <form action="listing_update.php" class="listing_form_5" id="listing_form_5"
                                ...
                                <ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" name="listing_submit" class="btn btn-primary"><?php echo $BIZBOOK['SAVE_AND_EXIT']; ?></button>
                                        </div>
                                        <div class="col-md-12">
