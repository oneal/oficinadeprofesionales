...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    if (isset($_POST['listing_submit_step_5'])) {
...
// Common Listing Details
        ...
        $listing_description = $_SESSION["listing_description"];
...
// Listing Location Details
        ...
        $prefix6 = $fruitList = $listing_video = '';
...
// Listing Service Names Details
        ...
        $service_1_name = $_SESSION["service_1_name"];

// Listing Offer Prices Details
        $service_1_price = $_SESSION["service_1_price"];

// Listing Offer Details
        $service_1_detail = addslashes($_SESSION["service_1_detail"]);

// Listing Offer View more link
        $service_1_view_more = $_SESSION["service_1_view_more"];

//Listing Other Informations
        $listing_info_question123 = $_SESSION["listing_info_question"];
        $prefix1 = $fruitList = $listing_info_question = '';
        ...
        $prefix1 = $fruitList = $listing_info_answer = '';
        ...
        $listing_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "listings  WHERE listing_slug='" . $listing_slug . "' and listing_is_delete <> 2");
...
//    Listing Insert Part Starts
        ...
        $listing_qry = "INSERT INTO " . TBL . "listings 
					(user_id, category_id, service_id, service_image, listing_type_id, listing_name, listing_mobile, listing_email
					...
					, 360_view, listing_video, service_1_name, service_1_price, service_1_detail, service_1_image, service_1_view_more, listing_status
					, listing_info_question , listing_info_answer, payment_status, listing_slug, listing_cdt) 
					VALUES 
					('$user_id', '$category_id', '$service_id', '$service_image', '$listing_type_id', '$listing_name', '$listing_mobile', '$listing_email', '$listing_website', '$listing_description', '$listing_address'
					, '$listing_lat', '$listing_lng', '$service_locations', '$country_id', '$state_id', '$city_id', '$profile_image', '$cover_image'
					,'$gallery_image', '$opening_days', '$opening_time', '$closing_time', '$fb_link', '$twitter_link', '$gplus_link', '$google_map'
					,'$threesixty_view', '$listing_video', '$service_1_name', '$service_1_price', '$service_1_detail', '$service_1_image', '$service_1_view_more', '$listing_status'
