            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login add-list-off">
                        ...
                        <form action="blog_delete.php" class="blog_delete_form" id="blog_delete_form" name="blog_delete_form"
                            ...
                            <ul>
                                <li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="blog_name"
                                                       value="<?php echo $blogs_a_row['blog_name']; ?>" readonly="readonly" class="form-control" placeholder="<?php echo $BIZBOOK['POST_NAME']; ?>*">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea name="blog_description" readonly="readonly" class="form-control" placeholder="<?php echo $BIZBOOK['POST_DETAILS']; ?>"><?php echo $blogs_a_row['blog_description']?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="blog_submit" class="btn btn-primary"><?php echo $BIZBOOK['DELETE_BLOG']; ?></button>
                                </div>
                                <div class="col-md-12">
