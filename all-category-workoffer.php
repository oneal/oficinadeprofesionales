...
<section>
    <div class="str all-cate-pg">
        <div class="container">
            <div class="row">
                <div class="home-tit">
                    <h2><span><?php echo $BIZBOOK['WORK_OFFERS'];?></span> <?php echo $BIZBOOK['HOM-POP-TIT1'];?>.</h2>
                    <p><?php echo $BIZBOOK['HOM-POP-SUB-TIT_2'];?>.</p>
                </div>
                <div class="land-pack">
                    <ul>

                        <?php
                        foreach (getAllCategoriesWorkOffer() as $category_sql_row) {
                            ?>
                            <li>
                                <div class="land-pack-grid">
                                    ...
                                    <div class="land-pack-grid-text">
                                        ...
                                        <a href="<?php echo $slash;?>ofertas-trabajo/<?php echo $category_sql_row['category_slug']; ?>" class="land-pack-grid-btn"><?php echo $BIZBOOK['VIEW_MORE'];?></a>
                                    </div>
                                </div>
                            </li>
                            <?php
