                    ...
                    <div class="log">
                        <div class="login">
                            ...
                            <div class="row cre-dup">
                                ...
                                <div class="col-md-6">
                                    <span class="cre-dup-btn"><?php echo $BIZBOOK['CREATE_DUPLICATE_LISTING_LABEL']; ?></span>
                                </div>
                            </div>
                            <form name="duplicate_listing_form" action="duplicate_listing_insert.php" id="duplicate_listing_form" method="post" class="cre-dup-form cre-dup-form-show">
                                <!--FILED START-->
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select name="listing_id" id="listing_id" class="chosen-select form-control"
                                                    required="required">
                                                <option value="" disabled selected><?php echo $BIZBOOK['LISTING_NAME']; ?></option>
                                                <?php
