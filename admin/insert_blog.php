...
//        }
        ...
        if (!empty($_FILES['blog_image']['name'])) {
            ...
            $blog_image = $blog_image_1;
        }

        $blog_slug = generar_texto_amigable($blog_name);
        $blog_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "blogs  WHERE blog_slug='" . $blog_slug . "' ");
...
//            $to = $admin_email;
//            $subject = $admin_site_name." - ".$BIZBOOK['NEW_BLOG_CREATE'];
//
...
//            $to1 = $email_id;
//            $subject1 = $admin_site_name.' - '.$BIZBOOK['BLOG_CREATION_SUCCESS'];
//
