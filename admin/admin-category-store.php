        ...
        <div class="ad-com">
            <div class="ad-dash leftpadd">
                ...
                <div class="ud-cen-s2 hcat-cho">
                    ...
                    <a href="admin-add-new-category-store.php" class="db-tit-btn"><?php echo $BIZBOOK['ADD_NEW_CATEGORY'];?></a>
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        <tbody>
                            <?php
                            $si=1;
                            foreach (getAllCategoriesStores() as $row) {

                                $category_id = $row['category_id'];

                                $category_store_count = getCountCategoryStore($category_id);
                                ?>
                                <tr>
                                    <td><?php echo $si; ?></td>
                                    ...
                                    <td><span class="db-list-ststus" data-toggle="tooltip"
                                              title="<?php echo $BIZBOOK['TOTAL_LISTINGS_CATEGORY'];?>"><?php echo $category_store_count; ?></span></td>
                                    <?php /*<td><span class="db-list-ststus"><?php echo $category_sub_category_count; ?></span></td>*/?>
                                    <td><a href="admin-category-store-edit.php?row=<?php echo $row['category_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['EDIT'];?></a></td>
                                    <?php /*<td><a href="admin-all-sub-category.php?cat=<?php echo $row['category_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['VIEW'];?></a></td>*/?>
                                    <td><a href="admin-category-store-delete.php?row=<?php echo $row['category_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['DELETE'];?></a></td>
                                </tr>
                                <?php
                                $si++;
                            }
