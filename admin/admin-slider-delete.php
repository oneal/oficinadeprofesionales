                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list posr">
                            ...
                            <span class="udb-inst"><?php echo $BIZBOOK['DELETE_SLIDER'];?></span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4><?php echo $BIZBOOK['DELETE_SLIDER'];?></h4>
                                    ...
                                    <form name="delete_ads_form" id="delete_ads_form" method="post" action="trash_slider.php" enctype="multipart/form-data">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <textarea readonly="readonly"  id="slider_link"  name="slider_link" class="form-control" placeholder="<?php echo $BIZBOOK['SLIDER_IMAGE_EXTERNAL_LINK'];?>" required><?php echo $row['slider_link']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--FILED END-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" name="delete_slider_submit" class="btn btn-primary"><?php echo $BIZBOOK['DELETE'];?></button>
                                            </div>
                                            <div class="col-md-12">
