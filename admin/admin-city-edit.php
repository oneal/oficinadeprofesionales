		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list add-ncate">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['EDIT'];?> <?php echo $BIZBOOK['CITY'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['EDIT'];?> <?php echo $BIZBOOK['CITY'];?></h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="city_name" value="<?php echo $row['city_name']; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['SUB_REGION_NAME'];?> *" required>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <button type="submit" name="city_submit" class="btn btn-primary"><?php echo $BIZBOOK['SAVE_CHANGES'];?></button>
                            </form>
                            <div class="col-md-12">
