...
//************ Category Name Already Exist Check Ends ***************
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . TBL . "product_categories (category_name,category_status,category_image,category_filter_pos_id,category_cdt)
VALUES ('$category_name','$category_status','$category_image','$category_filter_pos_id','$curDate')");
