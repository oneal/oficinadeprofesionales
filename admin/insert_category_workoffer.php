...
//************ Category Name Already Exist Check Starts ***************
        ...
        $category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "categories_work_offer  WHERE category_slug='" . $category_slug . "' ");
...
//************ Category Name Already Exist Check Ends ***************
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . TBL . "categories_work_offer (category_name,category_image,category_cdt,category_slug)
                VALUES ('$category_name','$category_image','$curDate','$category_slug')");
    ...
    if ($LID) {
        ...
        header('Location: admin-add-new-category-workoffer.php');
        exit;
    }
