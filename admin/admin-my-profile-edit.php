...
?>
    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $BIZBOOK['USER_EDIT_DETAILS'];?></span>
                <?php
                     $path_id = $_GET['path'];
                     $user_id = $_GET['row'];
                 ...
                 <div class="ud-cen-s2 ud-pro-edit">
                    <h2><?php echo $BIZBOOK['USER_EDIT_DETAILS'];?></h2>
                    <a href="admin-add-new-credits-user.php?row=<?php echo $user_details_row['user_id']; ?>" class="db-tit-btn"><?php echo $BIZBOOK['ADD_NEW_CREDIT'];?></a>
                         ...
                         <form name="register_form" id="register_form" method="post" action="update_user_profile.php"
                             ...
                             <table class="responsive-table bordered">
                                ...
                                <?php /*<tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" id="last_name" name="last_name" class="form-control" value="<?php echo $user_details_row['last_name']; ?>" required="required">
                                        </div>
                                    </td>
                                </tr>*/?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" id="cif_nif" name="cif_nif" class="form-control"
                                                   value="<?php echo $user_details_row['cif_nif']; ?>">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td><?php echo $BIZBOOK['CHANGE_PASSWORD'];?></td>
                                    <td>
                                        <div class="form-group">
                                     ...
                                     <td>
                                         <div class="form-group">
                                             <select name="user_type" required="required" id="user_type" class="form-control ca-check-plan">
                                                 ...
                                                 <option value="Prueba" <?php if($user_details_row['user_type'] == 'Prueba'){?>selected<?php }?>>Prueba</option>
                                             </select>
                                         </div>
                                     </td>
                                 </tr>
    ...
    //                                                 ?>
                                                     <option value="
    <?php //echo $plan_type_row['plan_type_id']; ?>">
    <?php //echo $plan_type_row['plan_type_name']; if($plan_type_row['plan_type_price'] != 0){ echo ' - '.$plan_type_row['plan_type_price'].'/year';} ?></option>
                                                     <?php
    //                                             }
    //                                             ?>
                                             </select>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <div class="form-group">
                                             <input type="text" value="<?php echo $user_details_row['user_linkedin']; ?>"
                                                    name="user_linkedin" class="form-control">
                                         </div>
                                     </td>
                                 </tr>
                                 <tr>
                                     ...
                                     <td>
                                         <div class="form-group">
                                             <input type="text" value="<?php echo $user_details_row['user_instagram']; ?>"
                                                    name="user_instagram" class="form-control">
                                         </div>
                                     </td>
                                 </tr>
                                 <tr>
                                     ...
                                     <td>
                                         <div class="form-group">
                                             <input type="text" value="<?php echo $user_details_row['user_whatsapp']; ?>"
                                                    name="user_whatsapp" class="form-control">
                                         </div>
                                     </td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                     <td><?php echo $BIZBOOK['NUM_CREDITS'];?></td>
                                     <td>
                                         <div class="form-group">
                                             <p><?php echo $user_details_row['user_credit']; ?></p>
                                         </div>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <button type="submit" name="register_submit" class="db-pro-bot-btn"><?php echo $BIZBOOK['SUBMIT'];?>
                                         </button>
                                     </td>
                                     <td></td>
                                 </tr>
