                                ...
                                <td>
                                    <div class="form-group">
                                        <select type="number" id="plan_type_photos_count"
                                            ...
                                            <?php /*
                                            <option ?php //if($row['plan_type_photos_count']== 15){ echo "selected"; } ?> value="15">15</option>
                                            <option <?php //if($row['plan_type_photos_count']== 20){ echo "selected"; } ?> value="20">20</option>
                                            <option <?php //if($row['plan_type_photos_count']== 1000){ echo "selected"; } ?> value="1000">Unlimited</option>
                                             * 
                                             */?>
                                        </select>
                                    </div>
                                ...
                                <td>
                                    <div class="form-group">
                                        <select type="number" id="plan_type_videos_count"
                                            ...
                                            <?php /*
                                            <option <?php //if($row['plan_type_videos_count']== 15){ echo "selected"; } ?> value="15">15</option>
                                            <option <?php //if($row['plan_type_videos_count']== 20){ echo "selected"; } ?> value="20">20</option>
                                            <option <?php //if($row['plan_type_videos_count']== 1000){ echo "selected"; } ?> value="1000">Unlimited</option>
                                             * 
                                             */?>
                                        </select>
                                    </div>
