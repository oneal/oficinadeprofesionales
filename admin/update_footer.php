...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['footer_submit'])) {
        ...
        if(!empty($_POST['footer_mobile'])){
            if(validation_phone($_POST['footer_mobile'])){
     ...
     , footer_twitter='" . $footer_twitter . "', footer_linked_in='" . $footer_linked_in . "', footer_instagram='" . $footer_instagram . "', footer_youtube='" . $footer_youtube. "'
