		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list posr">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['EDIT_NOTIFICATION'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['EDIT_NOTIFICATION'];?></h4>
                            ...
                            <form name="notification_form" id="notification_form" method="post" action="update_notification.php" enctype="multipart/form-data" class="">
                                ...
                                <ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" id="notification_title" value="<?php echo $notifications_row['notification_title']; ?>" name="notification_title" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['NOTIFICATIONS_TITLE'];?> *">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" id="notification_message" value="<?php echo $notifications_row['notification_message']; ?>" name="notification_message" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['NOTIFICATIONS_MESSAGE'];?> *">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" id="notification_link" value="<?php echo $notifications_row['notification_link']; ?>" name="notification_link" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['PAGE_LINK'];?> *">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" name="notification_submit" class="btn btn-primary"><?php echo $BIZBOOK['PAGE_LINK'];?></button>
                                    </div>
                                </div>
                                <!--FILED END-->
                            </form>
