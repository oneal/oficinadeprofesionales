                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list posr">
                            ...
                            <span class="udb-inst"><?php echo $BIZBOOK['EDIT_POPULAR_BUSINESS'];?></span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4><?php echo $BIZBOOK['EDIT_POPULAR_BUSINESS'];?></h4>
                                    ...
                                    <form name="listing_form" id="listing_form" method="post" action="update_home_popular_business.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" name="home_featured_listing_submit" class="btn btn-primary"><?php echo $BIZBOOK['SUBMIT'];?></button>
                                            </div>
                                            <div class="col-md-12">
                                                <a href="admin-home-popular-business.php" class="skip"><?php echo $BIZBOOK['GO_TO_POPULAR_BUSINESS'];?> >></a>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                    </form>
