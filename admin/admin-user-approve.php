...
//****************************    Admin email starts    *************************
            ...
            $to = $admin_email;
            $subject = $admin_site_name.' - '.$BIZBOOK['USER_REGISTRATION_APPROVAL_SUCCESS'];
            ...
            $to1 = $email_id;
            $subject1 = $admin_site_name.' - '.$BIZBOOK['USER_REGISTRATION_APPROVAL_SUCCESS'];
            ...
            $message2 =   stripslashes(str_replace(array('\' . $admin_site_name . \'', '\' . $first_name . \'', '\' . $email_id . \'','\' . $webpage_full_link_with_login . \'','\' . $logo . \''),
                array('' . $admin_site_name . '', '' . $first_name . '', '' . $email_id . '', '' . $webpage_full_link_with_login . '', '' . $logo . ''), $mail_template_client));
