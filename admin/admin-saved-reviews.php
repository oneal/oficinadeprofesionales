            ...
            <div class="ad-dash leftpadd">
                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered tb-bold-dis" id="pg-resu">
                            ...
                            $rrating = $reviewrow['overall_rating'];
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span class="enq-sav" data-toggle="tooltip" title="Click to save this review"><i class="material-icons  sav-act">favorite</i></span></td>
                                </tr>
                                <?php
                                $ri++;
                            }
