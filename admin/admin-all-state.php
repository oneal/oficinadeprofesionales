    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $BIZBOOK['STATES'];?></span>
                <div class="ud-cen-s2">
                    <h2><?php echo $BIZBOOK['ALL_STATES'];?></h2>
                    <?php include "../page_level_message.php"; ?>
                    <div class="ad-int-sear">
                        <input type="text" id="pg-sear" placeholder="<?php echo $BIZBOOK['SEARCH'];?>...">
                    </div>
                    <a href="admin-add-state.php" class="db-tit-btn"><?php echo $BIZBOOK['ADD_NEW_STATES'];?></a>
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        <tbody>
                            <?php
                            $si = 1;
                            foreach (getAllStates(1) as $row) {
                                
                                $country_id = $row['state_id'];

                                $state_listing_count = getCountStateListing($country_id);
                                
                                ?>
                                <tr>
                                    <td><?php echo $si; ?></td>
                                    <td><b class="db-list-rat"><?php echo $row['state_name']; ?></b></td>
                                    <?php /*<td><?php //echo dateFormatconverter($row['state_cdt']); ?></td>*/?>
                                    <td><span class="db-list-ststus" data-toggle="tooltip"
                                              title="Total listings in this category"><?php echo $state_listing_count; ?></span></td>
                                    <td><a href="admin-state-edit.php?row=<?php echo $row['state_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['EDIT'];?></a></td>
                                    <td><a href="admin-state-delete.php?row=<?php echo $row['state_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['DELETE'];?></a></td>
                                </tr>
                                <?php
                                $si++;
                            }
