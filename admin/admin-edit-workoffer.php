		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list posr">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['EDIT_WORK_OFFER'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['EDIT_WORK_OFFER'];?></h4>
                            ...
                            ?>
                            <form action="update_work_offer.php" class="work_offer_edit_form" id="work_offer_edit_form" name="work_offer_edit_form"
                                ...
                                <input type="hidden" id="work_offer_image_old"
                                       value="<?php echo $work_offer_row['work_offer_image']; ?>" name="work_offer_image_old"
                                       class="validate">
                                <ul>
                                    <li>
                                        <!--FILED START-->
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="work_offer_name"
                                                           value="<?php echo $work_offer_row['work_offer_name']; ?>" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['POST_NAME'];?> *">                                            </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                        <!--FILED START-->
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea name="work_offer_description" required="required" id="work_offer_description" class="form-control" placeholder="<?php echo $BIZBOOK['POST_DETAILS'];?>"><?php echo $work_offer_row['work_offer_description']?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div>
                                                    <div class="chbox">
                                                        <input type="checkbox" name="isenquiry" id="evefmenab" <?php if($work_offer_row['isenquiry'] == 1) { echo "checked"; }?>>
                            ...
                            <div class="col-md-12">
                                <a href="admin-all-workoffer.php" class="skip"><?php echo $BIZBOOK['GO_TO_DASHBOARD'];?> >></a>
                            </div>
                        </div>
                    </div>
                </div>
