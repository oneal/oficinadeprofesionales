                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst"><?php echo $BIZBOOK['SEND_INVOICES'];?></span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4><?php echo $BIZBOOK['SEND_INVOICES'];?></h4>
                                    ...
                                    <form name="send_invoice_form" action="insert_send_invoice.php" enctype="multipart/form-data" id="send_invoice_form" method="post" class="cre-dup-form cre-dup-form-show">
                                        <ul>
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label><?php echo $BIZBOOK['CHOOSE_INVOICE'];?></label>
                                        ...
                                        <button type="submit" name="invoice_submit" class="btn btn-primary"><?php echo $BIZBOOK['SUBMIT'];?></button>
                                    </form>
                                    <div class="col-md-12">
                                        <a href="admin-invoice-create.php" class="skip"><?php echo $BIZBOOK['GO_TO_CREATE_INVOICE'];?> >></a>
                                    </div>
