    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst"><?php echo $BIZBOOK['VIEW_MAIL_TEMPLATES'];?></span>
                <div class="ud-cen-s2 add-list">
                    ...
                    <div id="email_content" >
                        ...
                        ,'\' . $product_name . \'','\' . $product_mobile . \'','\' . $product_email . \''),
                            ...
                            ,'Eventzz', '987654xxxx', 'axx@gmxx.com', 'Blogzz', '987654xxxx', 'axx@gmxx.com', 'Productzz', '987654xxxx', 'axx@gmxx.com'), $mail_template));
                    ...
                    <input type="hidden" id="type_name" name="type_name" value="<?php //echo $type_name; ?>"/>
                    <button type="submit" name="mail_template_submit" class="btn-mpdf" id="mail_template">Update Mail Template</button>
                    </form>
                                        <div class="col-md-12">
                                            <a href="admin-send-invoice.php" class="skip">Send Invoice &gt;&gt;</a>
                                        </div>
                    <div class="ud-notes">
                        <p><b>Notes:</b> Hi, here you can able to edit most of the text except some default texts. You just click the text
