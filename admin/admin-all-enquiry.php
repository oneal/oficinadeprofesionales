    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $BIZBOOK['LISTING_ENQUERIES'];?></span>
                <div class="ud-cen-s2">
                     <h2><?php echo $BIZBOOK['ENQUERY_DETAILS'];?></h2>
                    ...
                    <table class="responsive-table bordered tb-bold-dis" id="pg-resu">
                        <thead>
                            <tr>
                                ...
                                <?php /*<th><?php echo $BIZBOOK['SAVED'];?></th>*/?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            foreach (getAllEnquiries() as $enquiries_row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $enquiries_row['ip']; ?></td>
