		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list add-ncate">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['CHANGE_EVENT_POSITION'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['CHOOSE_EVENT'];?></h4>
                            ...
                            <form class="cre-dup-form cre-dup-form-show" name="event_form" id="event_form" method="post" action="update_home_feature_events.php" enctype="multipart/form-data">
                                ...
                                <button type="submit" name="top_event_submit" class="btn btn-primary"><?php echo $BIZBOOK['SAVED'];?></button>
                            </form>
                            <div class="col-md-12">
                                    <a href="admin-home-feature-events.php" class="skip"><?php echo $BIZBOOK['GO_TO_FEATURE_EVENT'];?> >></a>
                                </div>
