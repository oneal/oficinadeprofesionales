        ...
        <div class="ad-com">
            <div class="ad-dash leftpadd">
                <div class="ud-cen">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['PENDING_INVOICES'];?></span>
                    <div class="ud-cen-s2">
                        <h2><?php echo $BIZBOOK['PENDING_INVOICES'];?></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                ...
                                <?php /*<a href="#" class="db-tit-btn" data-toggle="modal" data-target="#exportInvoiceModal" style="position: initial;">Exportar facturas</a>*/?>
                            </div>
                        </div>
                        <table class="responsive-table bordered" id="pg-resu">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach (getAllTransaction(1) as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <?php if($row['featured_listing_id']>0){?>
                                                <td><span class="db-list-rat"><?php echo $featured_listing_price_row['description'];?></span></td>
                                                <td><span class="db-list-rat"><?php echo $featured_listings_row['featured_total_days'];?> días</span></td>
                                            <?php }?>
                                            <?php if($row['featured_store_id']>0){?>
                                                <td><span class="db-list-rat"><?php echo $featured_store_price_row['description'];?></span></td>
                                            ...
                                            <td>
                                                <a href="generar_invoice.php?transaction_code=<?php echo $row['transaction_code']; ?>" class="db-list-edit">
                                                    <?php if($status_row_actual['id'] == 3){?>
                                                        Marcar pagado
                                                    <?php }else{?>
                                                        Generar factura
                                                    <?php }?>
