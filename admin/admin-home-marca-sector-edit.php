		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list posr">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['EDIT_MARCA'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['EDIT_MARCA'];?></h4>
                            ...
                            ?>
                            <form name="marca_form" id="marca_form" method="post" action="update_home_marca.php" enctype="multipart/form-data">

                                <input type="hidden" class="validate" id="marca_id" name="marca_id" value="<?php echo $row['marca_id']; ?>" required="required">
                                <input type="hidden" class="validate" id="marca_image_old" name="marca_image_old" value="<?php echo $row['marca_image']; ?>" required="required">
                                <ul>
                                    <li>
                                        <!--FILED START-->
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label><?php echo $BIZBOOK['CHOOSE_IMAGE'];?></label><br/>
