    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst"><?php echo $BIZBOOK['EDIT_EMAIL_TEMPLATE'];?></span>
                <div class="ud-cen-s2 add-list">
                    ...
                    <form method="post" name="mail_template_form" id="mail_template_form" action="update_mail.php">
                        ...
                        <button type="submit" name="mail_template_submit" class="btn-mpdf" id="mail_template"><?php echo $BIZBOOK['SAVED'];?>
                        </button>
                    </form>
                    <?php /*
                        <div class="col-md-12">
                    ...
                    <div class="ud-notes">
                        <p><b><?php echo $BIZBOOK['NOTES'];?></b> <?php echo $BIZBOOK['TEXT_EMAIL_TEMPLATE'];?></p>
                    </div>
                </div>
            </div>
        </div>
