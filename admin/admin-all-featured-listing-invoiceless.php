    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst">Fichas destacadas (Sin facturación)</span>
                <div class="ud-cen-s2">
                     <h2>Fichas destacadas (Sin facturación)</h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $BIZBOOK['PAYMENT_COST'];?></th>
                        ...
                        <tbody>
                            <?php
                            $si = 1;
                            foreach (getAllFeaturedListingInvoiceLess() as $row) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['featured_total_cost']; ?><?php echo $footer_row['currency_symbol']; ?></td>
