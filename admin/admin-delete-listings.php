                                ...
                                <div class="log log-1">
                                    <div class="login">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input readonly="readonly" id="listing_mobile" name="listing_mobile" type="tel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select disabled="disabled" name="city_id" id="city_id" required="required"
                                                            class="form-control">
                                                        <?php
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea readonly="readonly" class="form-control" name="google_map"
                                                              placeholder="<?php echo $BIZBOOK['ADDRESS'];?>"><?php echo $listings_a_row['google_map']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" name="listing_submit" class="btn btn-primary"><?php
                                                    if(isset($_GET['path'])){
                                                        if($_GET['path']=="restore"){
                                                            echo $BIZBOOK['RESTORE'];
                                                        }elseif($_GET['path']=="trash"){
                                                            echo $BIZBOOK['DELETE_PERMANENTLY'];
                                                        }
