    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $BIZBOOK['YEARS_EVENT'];?></span>
                <div class="ud-cen-s2 hcat-cho">
                    <h2><?php echo $BIZBOOK['YEARS'];?></h2>
                    <?php include "../page_level_message.php"; ?>
                    <div class="ad-int-sear">
                        <input type="text" id="pg-sear" placeholder="<?php echo $BIZBOOK['SEARCH'];?>..">
                    </div>
                    <a href="admin-add-new-year-event.php" class="db-tit-btn"><?php echo $BIZBOOK['ADD_NEW_YEAR'];?></a>
                    <table class="responsive-table bordered" id="pg-resu">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th><?php echo $BIZBOOK['YEAR'];?></th>
                        ...
                        <tbody>
                            ...
                            foreach (getAllYearEvents() as $row) {
                                ...
                                $year_store_count = getCountYearEvents($year_id);
                                ?>
                                <tr>
                                    <td><?php echo $si; ?></td>
                                    <td><b class="db-list-rat"><?php echo $row['year_name']; ?></b></td>
                                    <td><?php echo dateFormatconverter($row['year_cdt']); ?></td>
                                    <td><span class="db-list-ststus" data-toggle="tooltip"
                                              title="<?php echo $BIZBOOK['TOTAL_LISTINGS_CATEGORY'];?>"><?php echo $year_store_count; ?></span></td>
                                    <?php /*<td><span class="db-list-ststus"><?php echo $category_sub_category_count; ?></span></td>*/?>
                                    <td><a href="admin-year-event-edit.php?row=<?php echo $row['year_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['EDIT'];?></a></td>
                                    <?php /*<td><a href="admin-all-sub-category.php?cat=<?php echo $row['category_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['VIEW'];?></a></td>*/?>
                                    <td><a href="admin-year-event-delete.php?row=<?php echo $row['year_id']; ?>" class="db-list-edit"><?php echo $BIZBOOK['DELETE'];?></a></td>
                                </tr>
                                <?php
                                $si++;
                            }
