                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst"><?php echo $BIZBOOK['CHANGE_LISTING']?> </span>
                            <div class="log log-1">
                                <div class="login">
                                    <?php include "../page_level_message.php"; ?>
                                    <h4><?php echo $BIZBOOK['CHOOSE_LISTING_FOR']?> <?php echo $category_sql_row['category_name']; ?></h4>
                                    <form name="home_top_service_listing_form" id="home_top_service_listing_form" method="post" action="update_top_service_listing.php" class="cre-dup-form cre-dup-form-show">
                                        ...
                                        <button type="submit" name="home_top_service_listing_submit" class="btn btn-primary"><?php echo $BIZBOOK['SUBMIT'];?></button>
                                    </form>
                                    <div class="col-md-12">
                                        <a href="admin-home-top-services.php" class="skip"><?php echo $BIZBOOK['GO_TO_SERVICES'];?> >></a>
                                    </div>
