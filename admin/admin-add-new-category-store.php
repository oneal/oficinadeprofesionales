                        ...
                        <div class="login-main add-list add-ncate">
                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    <form name="category_form" id="category_form" method="post" action="insert_category_store.php" class="cre-dup-form cre-dup-form-show" enctype="multipart/form-data">
                                        <ul>
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-12">
