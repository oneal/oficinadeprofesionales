		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list posr">
                    ...
                    <span class="udb-inst"><?php echo $BIZBOOK['DUPLICATE_LISTING'];?></span>
                    <div class="log log-1">
                        <div class="login">
                            <h4><?php echo $BIZBOOK['CREATE_DUPLICATE_LISTING_LABEL'];?></h4>
                             <form name="duplicate_listing_form" action="insert_duplicate_listing.php" id="duplicate_listing_form" method="post" class="cre-dup-form cre-dup-form-show">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select name="listing_id" id="listing_id" class="form-control"
                                                        required="required">
                                                    <option value="" disabled selected><?php echo $BIZBOOK['NEW_LISTING_NAME_STAR'];?></option>
                                                    <?php
                                     ...
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             <select name="user_code" id="user_code" class="form-control"
                                                     required="required">
                                                 <option value="" disabled selected><?php echo $BIZBOOK['CHOOSE_USER'];?></option>
                                                 <?php
                                 ...
                                 <!--FILED START-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                              <input type="text" name="listing_name" required="required" class="form-control" placeholder="<?php echo $BIZBOOK['NEW_LISTING_NAME_STAR'];?> *">
                                            </div>
                                        </div>
                                    </div>
                                    <!--FILED END-->
                                <button type="submit" name="listing_submit" class="btn btn-primary"><?php echo $BIZBOOK['CREATE_NOW'];?></button>
                            </form>
                            <div class="col-md-12">
                                    <a href="user-profile-service-provider.html" class="skip"><?php echo $BIZBOOK['GO_TO_DASHBOARD'];?> >></a>
                                </div>
