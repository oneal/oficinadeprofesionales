                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllTypeUser($service_provider) as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($row['profile_image'] == NULL) || empty($row['profile_image'])){  echo "1.jpg";}else{ echo $row['profile_image']; } ?>" alt=""><?php echo $row['first_name']; ?> <span>Join: 
                                ...
                                <td><a href="admin-my-profile-edit.php?row=<?php echo $session_user_id; ?>&path=4" class="db-list-edit">Edit</a></td>
                                <td><a href="admin-my-profile-delete.php?row=<?php echo $session_user_id; ?>&path=4" class="db-list-edit">Delete</a></td>
