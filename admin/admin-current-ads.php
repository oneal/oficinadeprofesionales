    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $BIZBOOK['CURRENT_RUNNING_ADS'];?></span>
                <div class="ud-cen-s2">
                     <h2><?php echo $BIZBOOK['CURRENT_RUNNING_ADS'];?></h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $BIZBOOK['PAYMENT_DATE'];?></th>
                            ...
                            foreach (getAllActiveAdsEnquiry() as $row) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['ad_total_cost']; ?><?php echo $footer_row['currency_symbol']; ?></td>
