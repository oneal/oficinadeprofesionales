...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['category_submit'])) {
        ...
        $category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "categories_stores  WHERE  category_slug='" . $category_slug . "' AND category_id != $category_id ");
        ...
        $sql = mysqli_query($conn, "UPDATE  " . TBL . "categories_stores SET category_name='" . $category_name . "'
        ...
        if ($sql) {
            ...
            header('Location: admin-category-store-edit.php?row=' . $category_id);
            exit;
        }
    } else {
