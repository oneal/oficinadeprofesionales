...
//        }
     ...
     , plan_type_listing_count='" . $plan_type_listing_count . "', plan_type_product_count='" . $plan_type_product_count . "', plan_type_event_count='" . $plan_type_event_count . "', plan_type_blog_count='" . $plan_type_blog_count. "'
     ...
     , plan_type_trusted='" . $plan_type_trusted . "'
