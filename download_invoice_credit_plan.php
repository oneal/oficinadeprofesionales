    ...
    <tbody>
        <tr style="width: 700px;">
            ...
            <td style="width: 350px; text-align: right;">
                ...
                <p style="font-size:1em"><strong>Fecha emisión factura:</strong>' . date("d-m-Y", strtotime($transaction_row['transaction_create_cdt'])).'</p>
                <p style="font-size:1em"><strong>Fecha pago factura:</strong>' . date("d-m-Y", strtotime($transaction_row['transaction_pay_cdt'])).'</p>
            </td>
        </tr>
        <tr>
